...
export function DashboardClient({ user, rank, activities, leaderboard, referralCount, settings }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] grid-bg">
      ...
      {/* Referral welcome banner */}
        {user.referred_by && activities.some(a => a.type === 'referral') && typeof window !== "undefined" && !localStorage.getItem(`ref_banner_seen_${user.id}`) && (
